...
export function OrgSwitcher() {
	// We intentionally omit heavy providers on some public pages for performance.
	// On those routes, avoid throwing and just render nothing.
	const orgContext = useContext(OrganizationContext);
	if (!orgContext) return null;

	const { organization, userMemberships, switchOrganization, isLoading } = orgContext;
