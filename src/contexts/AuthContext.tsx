            ...
            async (event: any, session: any) => {
                ...
                if (session && session.user) {
                    ...
                    const userData = {
                        ...
                        avatar_url: session.user.user_metadata.avatar_url || session.user.user_metadata.profile_image_url,
            ...
            try {
                ...
                if (authResult.isAuthenticated && authResult.session?.user) {
                    ...
                    const userData = {
                        ...
                        avatar_url: authResult.session.user.user_metadata.avatar_url || authResult.session.user.user_metadata.profile_image_url,
                        organization_id: undefined as string | undefined,
    ...
    const login = async (email: string, password: string) => {
        try {
            ...
            const userData = {
                ...
                avatar_url: data.user.user_metadata.avatar_url || data.user.user_metadata.profile_image_url,
