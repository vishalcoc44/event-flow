                                    ...
                                    <HoverShadowEffect className="cursor-pointer" shadowColor="rgba(0,0,0,0.1)" shadowIntensity={0.15} hoverScale={1.02} hoverLift={-1} transitionDuration={150}>
                                        ...
                                        <CardHeader className="bg-white border-b py-3 px-4">
                                            <div className="flex items-center gap-3">
                                                <Avatar className="h-10 w-10 bg-[#6CDAEC] text-white flex-shrink-0">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    {customer.contact_number && (
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <span className="text-sm text-gray-700">{customer.contact_number}</span>
                                                        </div>
                                                    )}
                                                </div>
                                                    ...
                                                    <Accordion type="single" collapsible className="w-full">
                                                        <AccordionItem value="bookings" className="border-b-0">
                                                            <AccordionTrigger className="py-2 text-sm font-medium text-gray-900 hover:no-underline">
                                                                Booking History ({customerBookings[customer.id].length})
                                                            </AccordionTrigger>
                                                            <AccordionContent className="pb-0">
                                                                <div className="space-y-2 mt-2">
                                                                    {customerBookings[customer.id].map((booking) => (
                                                                        <div key={booking.id} className="p-2 bg-gray-50 rounded-md">
