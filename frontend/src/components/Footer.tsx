        ...
        <footer className="bg-[#E8FBFD] py-16">
            <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><Link href="/webinars" className="text-gray-600 hover:text-primary">Webinars</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="col-span-2 md:col-span-1">
                            ...
                            <div className="flex">
                                <input 
                                    ...
                                    className="px-4 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary w-full"
                                />
                                <GradientButton 
                                    variant="primary"
                                    size="sm"
                ...
                <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500 text-sm mb-4 md:mb-0">© 2024 EventFlow. All rights reserved.</p>
                    <div className="flex space-x-6">
                        <Link href="/terms" className="text-gray-500 text-sm hover:text-primary">Terms</Link>
                        <Link href="/privacy" className="text-gray-500 text-sm hover:text-primary">Privacy</Link>
                        <Link href="/cookies" className="text-gray-500 text-sm hover:text-primary">Cookies</Link>
                        <div className="flex items-center">
                            <span className="text-gray-500 text-sm mr-2">English</span>
