...
-- ========================================
-- STEP 2: Insert Templates and Create Indexes
-- ========================================
...
-- 7. Create function to create notification from template
...
-- 9. Create function to mark all notifications as read
...
-- ========================================
-- STEP 5: Create Event Notification Functions
-- ========================================

-- 11. Create function to notify followers of new events
...
-- 12. Create function to create event reminder notifications
...
-- 13. Create trigger for new events
...
-- 14. Create trigger for new bookings
...
-- 15. Create trigger for follow updates
...
-- ========================================
-- STEP 7: Create RLS Policies and Views
-- ========================================
...
-- 18. Create notification summary view
...
-- 19. Create function to clean old notifications
...
-- 20. Create function to process scheduled notifications
...
-- ========================================
-- STEP 9: Grant Permissions and Setup
-- ========================================
...
-- 22. Create default notification preferences for existing users
...
-- Test creating a notification (replace with actual user ID)
-- SELECT create_notification(
--     'your-user-id-here'::UUID,
--     'Test Notification',
--     'This is a test notification',
--     'EVENT_CREATED',
--     '{"event_title": "Test Event"}'::jsonb
-- );

-- Test creating notification from template (replace with actual user ID)
